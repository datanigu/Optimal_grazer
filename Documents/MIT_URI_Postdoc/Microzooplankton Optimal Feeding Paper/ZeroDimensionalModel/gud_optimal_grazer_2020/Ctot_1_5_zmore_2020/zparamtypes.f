...
c     &       (10.0**12.0)/(0.216*(zvmx(st,q)*10.0**18.0)**0.939)/3600.0! CORRECT! Based on Fenchel and Finlay (183)

      R0 = 0.0! Use if respiration will scale with ingestion, which would change in pzchangeII.f, based on Verity (1985)
